...
public class QSeat extends EntityPathBase<Seat> {
    ...
    private static final long serialVersionUID = 1664710538L;
    ...
    public final NumberPath<Integer> positionX = createNumber("positionX", Integer.class);

    public final NumberPath<Integer> positionY = createNumber("positionY", Integer.class);
    ...
    public final EnumPath<Seat.SeatStatus> status = createEnum("status", Seat.SeatStatus.class);
